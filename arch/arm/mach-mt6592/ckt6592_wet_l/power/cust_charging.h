...
#define MAX_CHARGE_TEMPERATURE  45 //50  //ckt guoyi modify 2014-3-19
#define MAX_CHARGE_TEMPERATURE_MINUS_X_DEGREE	42 //47 //ckt guoyi modify 2014-3-19
#define MIN_CHARGE_TEMPERATURE  0
#define MIN_CHARGE_TEMPERATURE_PLUS_X_DEGREE	5 //6 //ckt guoyi modify 2014-3-19
...
/*ckt guoyi add CKT  temperature NOTIFY 2015-6-26 start*/
#define TEMPERATURE_CKT_WARNING
#define MAX_HIGH_NOTIFY_TEMPERATURE 58				// HIGH NOTIFY TEMPERATURE
#define MIN_LOW_NOTIFY_TEMPERATURE -19				//LOW NOTIFY TEMPERATURE
#define MAX_CHARGE_POWEROFF_TEMPERATURE 60	 //POWEROFF TEMPERATURE
#define CKT_TEMP_0_THRESHOLD    (0)
#define CKT_TEMP_10_THRESHOLD   (10)
/*ckt guoyi add CKT  temperature NOTIFY 2015-6-26 end*/
