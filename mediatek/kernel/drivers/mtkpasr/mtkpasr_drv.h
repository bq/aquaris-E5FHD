...
#define MTKPASR_DPDON	0xFFFFFFFF	/* All banks belonging to it should be set as MTKPASR_RDPDON! */
/* Rank information (1 DPD unit) */
struct mtkpasr_rank {
	u16 start_bank;			/* The 1st bank */
	u16 end_bank;			/* The last bank */
	/*u32 hw_rank;*/		/* Corresponding to which hw rank */
	u32 inused;			/* The number of inuse banks or stands for DPD ON */
};
...
extern int compute_valid_pasr_range(unsigned long *start_pfn, unsigned long *end_pfn, u32 *banks_per_rank, int *num_ranks);
