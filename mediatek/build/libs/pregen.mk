...
ifeq ($(USING_TFA9890_EXTAMP),yes)
	$(hide) $(MTK_ROOT_SOURCE)/dct/DrvGen $(MTK_ROOT_CUSTOM)/$(PROJECT)/kernel/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)/codegen_tfa9890.dws $(MTK_ROOT_OUT)/DRVGEN $(MTK_ROOT_OUT)/DRVGEN $(DEAL_STDOUT_DRVGEN) $(MTK_DEPENDENCY_LOG)
ifneq ($(LOG),)
	@echo '[Dependency] $(PRIVATE_DRVGEN_DEPENDENCY) $(MTK_ROOT_CUSTOM)/$(PROJECT)/kernel/dct/$(PRIVATE_CUSTOM_KERNEL_DCT)/codegen_tfa9890.dws' >> $(LOG)$(basename $(notdir $@)).log
