...
const NVRAM_LENS_PARA_STRUCT T4K37AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
        ...
        {110,  // i4Offset
         ...
         0,  // i4MacroIdxOffset
        {
			 0, 10, 25,  40,  55,  76,	85,  100, 115, 130, 145,
			160, 175, 190, 205, 220, 235, 250, 365, 420, 495,
			 310, 325,	 0,   0,   0,	0,	 0,   0,   0,
...
UINT32 T4K37AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &T4K37AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pT4K37AF_getDefaultData = T4K37AF_getDefaultData;
