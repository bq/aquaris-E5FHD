...
static int s4BU6424AF_ReadReg(unsigned short * a_pu2Result)
{
    ...
    mt_set_gpio_mode(MT6323_POWER_LDO_VCAM_AF,GPIO_MODE_00);
    mt_set_gpio_dir(MT6323_POWER_LDO_VCAM_AF,GPIO_DIR_OUT);
    mt_set_gpio_out(MT6323_POWER_LDO_VCAM_AF,1);
...
static int BU6424AF_Release(struct inode * a_pstInode, struct file * a_pstFile)
{
    ...
    mt_set_gpio_out(MT6323_POWER_LDO_VCAM_AF,0);
