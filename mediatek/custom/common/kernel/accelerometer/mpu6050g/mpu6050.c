...
DEFINE_MUTEX(mpu6050_power); // 和陀螺仪共用 苏 勇 2013年12月09日 16:46:00
...
static int MPU6050_SetPowerMode(struct i2c_client *client, bool enable)
{
    ...
    databuf2[0] = MPU6050_REG_POWER_CTL2;   
...
static int mpu6050_init_client(struct i2c_client *client, int reset_cali)
{
    ...
    res = MPU6050_SetPowerMode(client, 0);
    if (res != MPU6050_SUCCESS)
    {
        return res;
    }
...
// 苏 勇 2013年12月12日 17:37:48    if (MPU6050_gyro_mode() == false) // 复位会导致陀螺仪和加速度全部打开,实际上就是没有休眠了 苏 勇 2013年12月12日 18:26:58
// 苏 勇 2013年12月12日 17:37:48    {
// 苏 勇 2013年12月12日 17:37:48        MPU6050_Dev_Reset(obj->client);
// 苏 勇 2013年12月12日 17:37:48        MPU6050_Reset(obj->client);
// 苏 勇 2013年12月12日 17:37:48    }
...
static int  mpu6050_set_acc_direction(struct i2c_client *client,int direction)
{
    int err = -1;
    struct mpu6050_i2c_data *obj = i2c_get_clientdata(client);
    if(err = hwmsen_get_convert(obj->hw->direction, &obj->cvt))
    ...
    i2c_set_clientdata(mpu6050_i2c_client, obj); 
}
...
{
    uint16_t val;
    struct mpu6050_i2c_data *gsensor_i2c_data = i2c_get_clientdata(mpu6050_i2c_client);
    ...
    {
        mpu6050_set_acc_direction(mpu6050_i2c_client,gsensor_i2c_data->hw->direction);
