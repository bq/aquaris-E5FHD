...
#define PACKET_SIZE		45		/* support 10 fingers packet */
#else
...
#define TPD_KEYS_DIM            {{180,1970,360,180},{540,1970,360,180},{900,1970,360,180}} //robin modify
...
// 苏 勇 2013年12月02日 15:02:33    	hwPowerOn(MT65XX_POWER_LDO_VGP6, VOL_1800, "touch"); //add by robin
	msleep(10);
#if 0
	/*LDO enable*/
...
static ssize_t show_chipinfo(struct device *dev,struct device_attribute *attr, char *buf)
{
	...
	switch (FW_ID)
	{
		case 0x14F5: // 创世 苏 勇 2013年11月13日 09:48:12
