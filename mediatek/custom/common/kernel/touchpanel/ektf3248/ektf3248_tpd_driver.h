#define ELAN_X_MAX 	 832 //robin modify 960//576  
#define ELAN_Y_MAX	 1536 //robin modify 1856 //1792//960 


#define LCM_X_MAX	1080 //robin modify simple_strtoul(LCM_WIDTH, NULL, 0)//896
#define LCM_Y_MAX	1920 //robin modify simple_strtoul(LCM_HEIGHT, NULL, 0)//1728

#define ELAN_KEY_BACK	0x21 //robin 0x81 // Elan Key's define
#define ELAN_KEY_HOME	0x41
#define ELAN_KEY_MENU	0x81 //robin 0x21
...
#else
static struct osd_offset OSD_mapping[] = {
  {180, 540, KEY_MENU},	//menu_left_x, menu_right_x, KEY_MENU
  {540, 900, KEY_HOME},	//home_left_x, home_right_x, KEY_HOME
  {900, 1260, KEY_BACK},	//back_left_x, back_right_x, KEY_BACK
};
#endif
