...
typedef struct{
		...
		unsigned char reserved[1024-40-64-20];//20140314 xiexijun add advancereset flag to nvram ,which is a factory request.
		char ps_cali_nvram_data[20];  //add by sen.luo for store ps offset
