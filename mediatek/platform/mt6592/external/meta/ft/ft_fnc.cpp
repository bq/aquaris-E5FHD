...
void FT_GetVersionInfo(FT_VER_INFO_REQ *req, char *pft_PeerBuf, kal_int16 ft_peer_len)
{
	...
	if(!strcmp((char const*)ft_cnf.sw_ver, ""))// Èç¹ûÎª¿ÕÊ¹ÓÃÄ¬ÈÏµÄ°æ±¾ºÅMTK_BUILD_VERNO,´¦ÀímetaµÄ°æ±¾ºÅ ËÕ ÓÂ 2013Äê07ÔÂ31ÈÕ 16:08:42
	{
...
void FT_CUSTOMER_OP(FT_CUSTOMER_REQ *pFTReq, char *pPeerBuf, kal_int16 peer_len)
{
	...
	switch (pFTReq->cmd.m_u1Dummy)//CKT add for ctp ver
	{
		case 1:
			GetCTPVersion(&p);
