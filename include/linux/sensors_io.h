...
#define ALSPS_GET_PS_CALI                   _IOR(ALSPS, 0x17, int)
#define ALSPS_GET_ID                        _IOR(ALSPS, 0x18, int)
#define ALSPS_RESET_PS                      _IOR(ALSPS, 0x19, int)
#define ALSPS_SET_PS_CALI           	    _IOR(ALSPS, 0x1A, int)
