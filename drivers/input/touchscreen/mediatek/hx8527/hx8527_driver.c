...
static int Check_FW_Version(void)
{
	...
	err:
		printk(KERN_ERR "Himax TP[%s]:[%d] read FW version error exit\n",__func__,__LINE__);
		return -1;
}
...
//
//=============================================================================================================
 static const struct i2c_device_id hx8527_tpd_id[] = {{"hx8527",0},{}};
 //unsigned short force[] = {0,0x90,I2C_CLIENT_END,I2C_CLIENT_END}; 
 //static const unsigned short * const forces[] = { force, NULL };
 //static struct i2c_client_address_data addr_data = { .forces = forces, };
static struct i2c_board_info __initdata hx8527_i2c_tpd={ I2C_BOARD_INFO("hx8527", (0x90>>1))};
 
 static struct i2c_driver tpd_i2c_driver = {
  .driver = {
	 .name = "hx8527",//.name = TPD_DEVICE,
//	 .owner = THIS_MODULE,
  },
  .probe = tpd_probe,
  .remove = tpd_remove,
  .id_table = hx8527_tpd_id,
  .detect = tpd_detect,
...
{
	i2c_register_board_info(0, &hx8527_i2c_tpd, 1);
