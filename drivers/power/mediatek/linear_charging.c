...
PMU_STATUS BAT_BatteryHoldAction(void)
{
	...
	battery_log(BAT_LOG_CRTI, "[BATTERY] Hold mode !!\n\r");
      //20140929 xiexijun add ckt baseline AT cmd for factory test
       if(BMT_status.bat_vol < TALKING_RECHARGE_VOLTAGE || (g_call_state == CALL_IDLE  && g_test_state == KAL_FALSE)){
