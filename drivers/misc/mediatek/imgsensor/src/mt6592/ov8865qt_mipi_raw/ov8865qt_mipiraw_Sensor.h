...
/* SENSOR FULL SIZE */
#ifndef __OV8865QT_SENSOR_H
#define __OV8865QT_SENSOR_H   
...
typedef struct
{
	...
	#define OV8865QT_MIPI_WRITE_ID 	(0x20)
	#define OV8865QT_MIPI_READ_ID		(0x21)


	static UINT32 OV8865MIPIOpen(void);
	static UINT32 OV8865MIPIGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution);
	static UINT32 OV8865MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
	static UINT32 OV8865MIPIControl(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *pImageWindow, MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData);
	static UINT32 OV8865MIPIFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,UINT32 *pFeatureParaLen);
	static UINT32 OV8865MIPIClose(void);
