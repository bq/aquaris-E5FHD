...
static LCM_setting_table_V3 lcm_initialization_setting[] = {
	...
	{0x15,0x00,1,{0xb3}},
	{0x15,0xc0,1,{0x33}},//c4b3 0x33
	
	
	{0x15,0x00,1,{0x80}},
	{0x15,0xc4,1,{0x04}},//c480 0x84
	
	{0x15,0x00,1,{0x83}},
	{0x15,0xc4,1,{0x02}},//c483 0x22
	
	{0x15,0x00,1,{0xf8}},
	{0x15,0xc2,1,{0x40}},//c2f8 0x40
	
	{0x15,0x00,1,{0x80}},
	{0x15,0xA5,1,{0x0C}},//A580 0x0C
	
	{0x15,0x00,1,{0x81}},
	{0x15,0xA5,1,{0x04}},//A581 0x04
				
	{0x15,0x00,1,{0xE6}},
	{0x39,0xCD,3,{0x08,0x08,0x08}},	//CDE6 0x08 0x08 0x08
	
	{0x15,0x00,1,{0xF2}},
	{0x39,0xC2,2,{0x04,0x04}},//C2F2 0x04 0x04
	
	{0x15,0x00,1,{0xFD}},
	{0x39,0xC2,3,{0xFF,0xFF,0xFF}},	//C2FD 0xFF 0xFF 0xFf
	
	{0x15,0x00,1,{0x9A}},
	{0x39,0xC5,3,{0x22,0x22,0x20}},	//C59A 0x22 0x22 0x20
	
	{0x15,0x00,1,{0xA2}},
	{0x15,0xC1,1,{0x21}},//C1A2 0x21
	
	//end
	{0x15,0x00,1,{0x81}},
	{0x15,0xC1,1,{0x19}},
//add for tianma otm1285a lcd flicker when play music by tyrael
	{0x15,0x35,1,{0x00}},//enable TE
//end	 
	{0x15,0x51,1,{0xFF}},
	{0x15,0x53,1,{0x2C}},
	{0x15,0x55,1,{0x00}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch					= 0x05; //0x0d;// 20   1
	params->dsi.vertical_frontporch					= 0x12;//0x08; // 1  12
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 

	params->dsi.horizontal_sync_active				= 0x8;//
	params->dsi.horizontal_backporch				= 120;//0x5f
...
{
#ifndef BUILD_LK
	printk("---otm1285a_hd720_dsi_vdo_tianma---[%s]",__func__);
#endif
	lcm_init();
