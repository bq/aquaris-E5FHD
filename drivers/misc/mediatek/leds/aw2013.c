...
static struct i2c_driver aw2013_i2c_driver = {
        .driver = 
	   {
        ...
        .remove         =  __exit_p(AW2013_i2c_remove),
...
static int __init AW2013_i2c_probe(struct i2c_client *client,
...
static int __exit AW2013_i2c_remove(struct i2c_client *client)
{
