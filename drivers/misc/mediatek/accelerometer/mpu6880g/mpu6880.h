...
#define MPU6880_I2C_SLAVE_ADDR		0xD2


/* MPU6880 Register Map  (Please refer to MPU6880 Specifications) */
#define MPU6880_REG_DEVID			0x75
#define	MPU6880_REG_BW_RATE			0x1A
#define MPU6880_REG_POWER_CTL                   0x6B 
#define MPU6880_REG_POWER_CTL2                  0x6C
#define MPU6880_REG_INT_ENABLE		0x38 
#define MPU6880_REG_DATA_FORMAT		0x1C 
#define MPU6880_REG_DATAX0			0x3B 
#define MPU6880_REG_DATAY0			0x3D
#define MPU6880_REG_DATAZ0			0x3F
#define MPU6880_REG_RESET               0x68

/* register Value */ 
#define MPU6880_FIXED_DEVID         0x68 // or 0x69
													
                                           // delay(ms)	
#define MPU6880_BW_260HZ            0x00   //0     
#define MPU6880_BW_184HZ            0x01   //2.0     
#define MPU6880_BW_94HZ             0x02   //3.0   
#define MPU6880_BW_44HZ             0x03   //4.9   
#define MPU6880_BW_21HZ             0x04   //8.5   
#define MPU6880_BW_10HZ             0x05   //13.8  
#define MPU6880_BW_5HZ              0x06   //19.0  

#define MPU6880_DEV_RESET           0x80
