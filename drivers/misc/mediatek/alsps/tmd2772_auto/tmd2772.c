...
#if DO_CALIBARTION //ckt liutao move to here for avoid change TMD2772_CMM_ENABLE in doing calibration
...
// yong.su 2014-01-06 20:14:45	printk("<suyong> <%d>,%s(),again=%d,buffer=%d\n",__LINE__,__func__,again,buffer[0] );
		switch (again)
		{
			case 0:
				again=1;
...
// yong.su 2014-01-06 20:14:57	printk("<suyong> <%d>,%s(),c0_value=%d c1_value=%d atime=%d again=%d\n",__LINE__,__func__ ,
// yong.su 2014-01-06 20:14:57		c0_value,c1_value,atime,again);
...
// yong.su 2014-01-06 20:15:00			printk("<suyong> <%d>,%s(),lux1=%d lux2=%d tmp=%d *data=%d\n",__LINE__,__func__ ,
// yong.su 2014-01-06 20:15:00				lux1,lux2,temp,*data);
	}
	return 0;	 
...
// yong.su 2014-01-07 14:04:49		return obj->hw->als_value[idx];
// yong.su 2014-03-28 11:23:19		#if defined(MTK_AAL_SUPPORT)
		...
		return value;
// yong.su 2014-03-28 11:23:27		#endif
        //APS_DBG("ALS: %05d => %05d\n", als, obj->hw->als_value[idx]);
...
// yong.su 2014-01-06 18:35:24		if(obj->als > 40000)
// yong.su 2014-01-06 18:35:24			{
// yong.su 2014-01-06 18:35:24			APS_LOG("TMD2772_eint_work ALS too large may under lighting als_ch0=%d!\n",obj->als);
// yong.su 2014-01-06 18:35:24			return;
// yong.su 2014-01-06 18:35:24			}
	...
	switch (command)
	{
		...
		case SENSOR_GET_DATA:
			...
			//	sensor_data->values[0] = obj->als;
				...
				sensor_data = (hwm_sensor_data *)buff_out;
				sensor_data->values[0] = obj->als;
				TMD2772_read_als_ch0(obj->client, &obj->als); // ֻget als ch0 yong.su 2014-01-08 18:08:35
				sensor_data->values[0] = TMD2772_get_als_value(obj, obj->als);
				sensor_data->value_divide = 2;
				sensor_data->status = SENSOR_STATUS_ACCURACY_MEDIUM;
#endif
